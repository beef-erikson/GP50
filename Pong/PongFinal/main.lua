...
function love.update(dt)
    ...
    elseif gameState == 'play' then
        ...
        -- value of 3 is used to prevent 'jerking'
        if ball.y < player2.middleY - 3 then
            player2.dy = -PADDLE_SPEED
        elseif ball.y > player2.middleY + 3 then
            player2.dy = PADDLE_SPEED
        else
            player2.dy = 0
        end
...
--[[
    Called on window resize, pass in window and height to push
    so that virtual resolution can resize as needed
]]
